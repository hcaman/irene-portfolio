...
const Qualification = () => {
    const {allDatoCmsQualificationItem, allDatoCmsSectionsTitle} = useStaticQuery(graphql`
        query {
    ...
    const sectionOpst = { 
        ...
        littleTitle: allDatoCmsSectionsTitle.nodes[0]?.littleTitle || 'Education & Expericence'
    };
